...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightPos = glm::vec3(2.0f * sin(glfwGetTime()) + 1.0f, sin(glfwGetTime() / 2.0f) * 1.0f, 2.0f);
        ...
        glm::vec3 diffuseColor = lightColor * glm::vec3(0.5f); // decreased influence
